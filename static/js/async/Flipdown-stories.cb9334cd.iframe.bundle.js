"use strict";(self.webpackChunkreact_flipdown=self.webpackChunkreact_flipdown||[]).push([["441"],{"./src/Flipdown.stories.ts":function(e,t,r){r.r(t),r.d(t,{Primary:()=>L,__namedExportsOrder:()=>R,default:()=>_});var s=r("../../node_modules/react/jsx-runtime.js"),o=r("../../node_modules/react/index.js"),i=r("../../node_modules/styled-components/dist/styled-components.browser.esm.js");let n=()=>{let e=(0,o.useRef)(!0);return(0,o.useEffect)(()=>{e.current=!1},[]),e.current},a=(0,i.iv)`
...
`;function D(e){let{title:t,value:r,showLabels:i=!0,showSeparators:n=!0}=e,[a,d]=(0,o.useMemo)(()=>String(r.current).padStart(2,"0").split(""),[r.current]),[l,u]=(0,o.useMemo)(()=>String(r.previous).padStart(2,"0").split(""),[r.previous]);return(0,s.jsxs)(y,{hiddenSeparators:!n,children:[(0,s.jsx)(k,{title:t,hidden:!i}),(0,s.jsxs)(f,{children:[(0,s.jsx)(v,{value:a,prevValue:l}),(0,s.jsx)(v,{value:d,prevValue:u})]})]})}D.__docgenInfo={description:"",methods:[],displayName:"RotorGroup",props:{title:{required:!0,tsType:{name:"string"},description:""},value:{required:!0,tsType:{name:"signature",type:"object",raw:"{\n    current: number,\n    previous: number,\n}",signature:{properties:[{key:"current",value:{name:"number",required:!0}},{key:"previous",value:{name:"number",required:!0}}]}},description:""},showLabels:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},showSeparators:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};let S=e=>e>=365?365:e<0?0:e,j=e=>e>=24?24:e<0?0:e,E=e=>e>=60?60:e<0?0:e,F=e=>e>=60?60:e<0?0:e,q=(e,t)=>{let r=new Date().getTime()/1e3,s=e-r<=0?0:e-r,o=Math.floor(s/86400),i=Math.floor((s-=86400*o)/3600),n=Math.floor((s-=3600*i)/60),a=Math.floor(s-=60*n);return{days:{current:o,previous:t?o:S(o-1)},hours:{current:i,previous:t?i:j(i-1)},minutes:{current:n,previous:t?n:E(n-1)},seconds:{current:a,previous:t?a:F(a-1)}}},T=i.ZP.div`
    display: flex;
    column-gap: 1.5rem;
    justify-content: center;
    overflow: visible;
